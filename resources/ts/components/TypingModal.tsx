...
import '@scss/components/typing.scss';
...
const TypingModal: React.FC<ModalProps> = ({ showFlag, setShowFlag }) => {
    return (
        <>
            {showFlag ? (
                <div id="game-overlay">
                    <div id="game-screen">
                        <div id="game-header">
                            <div className="description">e-typing風タイピングゲーム</div>
                            <button id="close-button1" type="button" onClick={() => setShowFlag(false)}>閉じる</button>
                        </div>
                        <div id="game-body">
                            <div id="game-view1">
                            ...
                            <div id="game-result">
                                <div id="current-result">
                                    <div className="result-title">今回のタイピング結果</div>
                                    <div id="example-list"></div>
                                    <div className="result-data"></div>
                                </div>
                                <div id="prev-result">
                                    <div className="result-title">前回の結果</div>
                                    <div className="result-data"></div>
                                </div>
                                ...
                                <div id="btn-area">
                                    <button id="replay-button" className="btn" type="button">もう1回</button>
                                    <button id="close-button2" className="btn" type="button">閉じる</button>
                                </div>
                            </div>
                        </div>
                    </div>
